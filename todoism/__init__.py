...
from todoism.extensions import db, login_manage, csrf, babel, swagger
...
from todoism.models import Item, Pet, User
from todoism.settings import config
from todoism.apis.v1 import api_v1
from todoism.apis.v2 import api_v2
...
def register_template_context(app):
    ...
    def make_template_context():
        ...
        return dict(active_items=active_items, Locale=Locale)


def register_shell_context(app):
    @app.shell_context_processor
    def make_shell_context():
        return dict(Pet=Pet, User=User, Item=Item)
