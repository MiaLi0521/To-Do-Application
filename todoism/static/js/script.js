$(function () {
   ...
   // bind a callback that executes when document.location.hash changes
    ...
    if (window.location.hash === ''){
        ...
        $(window).trigger('hashchange'); // 触发hashchange事件，重载页面
    }
    ...
    $(document).on('click', '.edit-btn', function () {
        ...
        $item.after('\
            ...
            <input class="validate" id="edit-item-input" type="text" value=">' + itemBody + '" autocomplete="off"\
            autofocus required>\
            </div>');
